...
class RenitialisationEmailService {
  // Envoyer email de renitialisation de compte avec mot de passe
  async sendRenitialisationEmail(userEmail, username, password) {
...
module.exports = new RenitialisationEmailService();
